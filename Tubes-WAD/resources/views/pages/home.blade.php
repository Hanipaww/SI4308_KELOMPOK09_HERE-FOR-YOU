...
<div class="container mt-5">
   <div class="row">
       <div class="col-12">
           <h4 class="text-left">Pengenalan Web HereForYou</h4>
           <p>
               Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laboriosam est rem laborum exercitationem quo blanditiis, assumenda nulla accusamus deserunt maiores molestiae? Voluptatem quasi culpa tempore voluptatibus iure nam est dolor.
           </p>
           <ul class="list-unstyled">
               <li>
                    Nama Web : {{ config('app.name') }}
               </li>
               <li>
                   Call Center : 1818
               </li>
           </ul>
           <h4 class="text-left">Kesehatan Mental itu Penting</h4>
           <p>
                <p> Dr. Brock Chisholm, mengatakan ”without mental health there can be no true physical health” yang berarti tanpa kesehatan mental kita gak akan mendapatkan kesehatan fisik yang sebenarnya.</p>
